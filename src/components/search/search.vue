<template>
    <div class="search">
        ...
        <div class="shortcut-wrapper" v-show="!newQuery" ref="shortcutWrapper">
        ...
        <div class="search-result" v-show="newQuery" ref="searchResult">
            <suggest ref="suggest" @select="saveSearch" @listScroll="blurInput" :query="newQuery"></suggest>
        </div>
